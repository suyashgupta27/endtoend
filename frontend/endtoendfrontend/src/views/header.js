...
function header() {
  ...
  <div className="container flex items-center justify-center h-full max-w-6xl px-8 mx-auto sm:justify-between xl:px-0">
    <a
      href="/"
      className="relative flex items-center inline-block h-15 h-full font-black leading-none"
    >
      <svg
        className="w-auto h-14 text-red-400 fill-current"
        viewBox="0 0 194 116"
      ...
      <span className="ml-3 text-xl text-gray-800">
        Encrypt It<span className="text-pink-500">.</span>
      </span>
    </a>
    <nav
      id="nav"
    ...
    <div className="absolute left-0 flex-col items-center justify-center hidden w-full pb-8 mt-48 border-b border-gray-200 md:relative md:w-auto md:bg-transparent md:border-none md:mt-0 md:flex-row md:p-0 md:items-end md:flex md:justify-between">
      ...
      <a
        href="/login"
        className="relative left-9 z-40 inline-block w-auto h-full px-11 py-3 text-sm font-bold leading-none text-white transition-all transition duration-100 duration-300 bg-indigo-700 rounded shadow-md fold-bold lg:bg-white lg:text-indigo-700 sm:w-full lg:shadow-none hover:shadow-xl"
      >
        Login
      </a>
      <svg
